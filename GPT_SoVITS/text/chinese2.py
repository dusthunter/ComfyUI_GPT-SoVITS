...
if is_g2pw:
    ...
    # 修改引用路径
    g2pw = G2PWPinyin(model_dir=os.path.join(current_file_path, "G2PWModel"),model_source=os.path.join(parent_directory,"pretrained_models/chinese-roberta-wwm-ext-large"),v_to_u=False, neutral_tone_with_five=True)
